...
function SpeedTest() {
    ...
    const services = [
        { id: 1, active: false, img: "../../images/network-1.webp", service: "طراحی و زیر ساخت شبکه" },
        { id: 2, active: false, img: "../../images/wireless.webp", service: "اینترنت و شبکه های وایرلس" },
        { id: 3, active: false, img: "../../images/firewall.webp", service: "فایروال های سخت افزار" },
        { id: 4, active: false, img: "../../images/network-monitoring.webp", service: "نظارت پیشرفته بر شبکه" },
        { id: 5, active: false, img: "../../images/VRS.webp", service: "سرور مجازی" },
        { id: 6, active: false, img: "../../images/cable.webp", service: "کابل کشی شبکه" },
        { id: 7, active: false, img: "../../images/voip-phone.webp", service: "تلفن VOIP" },
        { id: 8, active: false, img: "../../images/managing-users.webp", service: "مدیریت کاربران" },
        { id: 9, active: false, img: "../../images/eset.webp", service: "آنتی ویروس" },
        { id: 10, active: false, img: "../../images/camera.webp", service: "دوربین مدار بسته" },
        { id: 11, active: false, img: "../../images/security.webp", service: "ارتباط امن بین دفاتر" },
        { id: 12, active: false, img: "../../images/moshavere.webp", service: "مشاوره رایگان" }
    ]
    return (
        <div className="services w-full h-[1250px] relative">
            <div className="services-container w-full h-full flex flex-col absolute left-[50%] translate-x-[-50%] max-w-[1011px]">
                <div className="timeline w-full h-full flex flex-col items-center justify-between relative">
                    <div className=' spinner-container absolute'>
                        <div className="spinner ">
                            <div className="spinner1"></div>
                        </div>
                    </div>
                    <div className=' spinner-container2 absolute'>
                        <div className="spinner ">
                            <div className="spinner1"></div>
                        </div>
                    </div>
                    <div className=' flex flex-col gap-5'>
                        {
                            services.map((item) => {
                                return (
                                    <div ref={timeLineRef} key={item.id} data-aos={item.id % 2 === 0 ? "zoom-in" : "zoom-in"} className={`timeline-item w-80 smmax:w-72 xsmmax:w-64 max-h-40 flex ${item.id % 2 === 0 ? " flex-row" : "flex-row-reverse"} justify-center items-center p-2 gap-5 rounded-2xl`}>
                                        <img className={` w-20 img-services aspect-[1.5] object-contain`} src={item.img} alt="" />
                                        <span className=' text-sm smmax:text-[12px]'>
                                            {item.service}
                                        </span>
                                    </div>
                                )
